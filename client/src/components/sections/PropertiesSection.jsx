  ...
  return (
    <section id="properties" className="section properties-section">
      <div className="container">
        ...
        <div className="prop-feature-card reveal open-modal" data-modal="hombelaku" style={{ cursor: "pointer" }}>
          <div className="prop-img-col">
            <div className="prop-img-wrap">
              <img src="property.jpg" alt="Hombelaku Residential Building, Mysuru" />
